<template>
  <header class="mb-[18px]">
    <HeaderIcon />
    <div class="pt-[35px] px-[15px] flex justify-between gap-x-[50px]">
      <div
    ...
    <div class="pt-[30px] px-[11px] flex justify-between items-center">
      <ul class="flex gap-x-[20px] text-black text-[13px] font-bold">
